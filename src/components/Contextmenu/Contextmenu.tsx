...
function Contextmenu({
  ...
  const menuDotsKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
    if (e.keyCode === 13) {
      setContextMenuOpen(!contextMenuOpen);
    }
  };
  ...
  const menuEditKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
    if (e.keyCode === 13) {
      startEdit();
    }
  };
  ...
  const menuDeleteKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
    if (e.keyCode === 13) {
      setAnimation('anim');
      if (deleted) {
  ...
  const menuRecoverKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
